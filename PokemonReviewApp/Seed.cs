                        ...
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review {
                                    ...
                                    {
                                        FirstName = "Teddy", LastName = "Smith"
                                    }
                                },
                                new Review
                                {
                                    Title = "Pikachu",
                                    Text = "Pikachu is the best a killing rocks",
                                    Rating = 5,
                                    Reviewer = new Reviewer()
                                    {
                                ...
                                new Review
                                {
                                    ...
                                    Reviewer = new Reviewer()
                                    {
                                        FirstName = "Jessica", LastName = "McGregor"
                                    }
                                }
                            }
                        },
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review {
                                    Title = "Squirtle",
                                    Text = "Squirtle is the best pokemon, because it is water",
                                    Rating = 5,
                                    Reviewer = new Reviewer()
                                    {
                                        FirstName = "Teddy", LastName = "Smith"
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review {
                                    Title = "Venasuar",
                                    Text = "Venasuar is the best pokemon, because it is leaf",
                                    Rating = 5,
                                    Reviewer = new Reviewer()
                                    {
                                        FirstName = "Teddy", LastName = "Smith"
